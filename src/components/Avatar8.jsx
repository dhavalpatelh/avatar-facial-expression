...
// ====================================================================================
// COMPONENTE AVATAR FINALE
// ====================================================================================
export function Avatar8(props) {
    ...
    useFrame((state) => {
        ...
        const animatedMeshes = [head, teeth, tongue];
                ...
                animatedMeshes.forEach(mesh => {
                    ...
                    if (morphIndex !== undefined) {
                        mesh.morphTargetInfluences[morphIndex] = THREE.MathUtils.lerp(
                            mesh.morphTargetInfluences[morphIndex], 1, morphTargetSmoothing
                        );
                    }
                });

                // Anima occhi e sopracciglia
...
// Pre-carica il modello per un'esperienza più fluida
